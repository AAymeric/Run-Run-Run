...
this.asyncStorage = (function() {
  ...
  function withStore(type, f) {
    if (db) {
      ...
      openreq.onupgradeneeded = function withStoreOnUpgradeNeeded() {
        ...
        openreq.result.createObjectStore(STORENAME_CONF);
        openreq.result.createObjectStore(STORENAME_SPORTS);
        openreq.result.createObjectStore(STORENAME_EVENTS);
         openreq.result.createObjectStore(STORENAME_RECORDS);
      };
  ...
  function setItem(store, key, value, callback) {
  ...
  function removeItem(store, key, callback) {
